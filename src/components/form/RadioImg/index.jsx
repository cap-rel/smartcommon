                    ...
                    >
                        ...
                        <div className={`absolute inset-0 p-2`}>
                            ...
                            >
                                ...
                                />
                                <Icon library={`io5`} icon={`IoClose`} className={`absolute top-0.5 right-0.5`} style={{ color: option.colors.primary }}/>
                                <Icon library={`fa6`} icon={`FaArrowPointer`} className={`absolute-v-center left-1`} style={{ color: option.colors.secondary || option.colors.primary }}/>
                            </div>
                        </div>
                    </div>
