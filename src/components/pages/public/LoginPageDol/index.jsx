      ...
      <p className={`font-bold uppercase text-2xl`}>
        ...
        <div className={`col gap-3 sm:gap-4`}>
          <div className={`col gap-3`}>
            ...
            <div 
              className={`border border-dol row-v-center gap-3 p-3 rounded-md bg-light-soft dark:bg-transparent`}
          ...
          <div className={`col gap-3`}>
            ...
            >
              ...
              <input
                ...
                required={false}
                title={`Mot de passe`}
                className={`flex-grow min-w-0 outline-none bg-transparent placeholder-dol`}
              />
              <button 
                ...
                className={`flex-shrink-0 text-soft-dol text-2xl button-dol`}
              >
                <Icon
                  library={`fa`}
          ...
          <div className={`row-between-center gap-3 text-sm`}>
            <div className={`row-v-center ml-1 flex-grow`}>
              ...
              >
                ...
                />
                <div className={`border border-dol w-7 h-7 rounded-md relative flex-shrink-0 bg-light-soft dark:bg-transparent`}>
                  <Icon
                    library={`fa`}
                    icon={`FaCheck`}
                    className={`  
                ...
                <span className={`text-soft-dol`}>{t("public.rememberMeLabel")}</span>
              </label>
              <Help
            ...
            <Link 
              to={`/forgot-password`} 
              className={`link-dol text-primary mr-2`}
            >
