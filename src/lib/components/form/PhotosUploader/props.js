...
export const DEFAULT_LABELS = {
    requiredError: "You must take at least 1 photo.",
    minError: (min) => `You must take at least ${min} photos.`,
    maxError: (max) => `You cannot take more than ${max} photos. Please delete some.`,
    exactError: (exact) => `You must take exactly ${exact} photos.`,
    geolocationError: "Failed to get capture location.",
    uploadError: "Photo upload failed.",
    clickToShow: "Click to view the image",
    pendingBadge: "Sending...",
    photoPopupTitle: (index) => `Photo ${index + 1}`,
    photoPopupTitleSingle: "Saved photo",
    titleField: "Title",
    descriptionField: "Description",
    saveButton: "Save",
    emptyState: "No photo saved",
};